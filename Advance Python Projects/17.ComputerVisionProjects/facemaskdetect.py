...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Flatten, Dropout, Dense # type: ignore
...
# Labels and color dict for mask detection
labels_dict = {0: 'No mask', 1: 'Mask'}
color_dict = {0: (0, 0, 255), 1: (0, 255, 0)}

# Set image resize for face detection
imgsize = 4
# Turn on the camera
